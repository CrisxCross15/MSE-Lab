...
/**
 * @brief  Check if a byte has been received on USART2.
 *
 *  Reads SR.RXNE – set by hardware when the receive data register
 *  contains a new byte ready to be read.
 *
 ...
 *
 *  Polls SR.RXNE until a byte arrives, then reads DR.
 *  Reading DR clears the RXNE flag automatically.
 *
